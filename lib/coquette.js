...
;(function(exports) {
  ...
  Inputter.prototype = {
    ...
    isUndown: function(button) {
      return this._buttonListener.isUndown(button);
    },
  ...
  ButtonListener.prototype = {
    update: function() {
      for (var i in this._buttonPressedState) {
        ...
        if (this._buttonUndownState[i] === true) {
          this._buttonUndownState[i] = false;
        }
      }
    },
    ...
    _up: function(buttonId) {
      ...
      this._buttonUndownState[buttonId] = true;
